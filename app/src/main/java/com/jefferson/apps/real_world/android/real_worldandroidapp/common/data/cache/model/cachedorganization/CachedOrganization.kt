package com.jefferson.apps.real_world.android.real_worldandroidapp.common.data.cache.model.cachedorganization
...
data class CachedOrganization(
    ...
    fun toDomain(): Organization{
        return Organization(
            organizationId,
            Organization.Contact(email, phone, Organization.Address(address1, address2, city, state, postcode, country)),
            distance
        )
    }
}
